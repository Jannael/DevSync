...
<Aside type="tip">
  We recommend using serverless hosting platforms like Vercel, Cloudflare Pages, or Netlify. They are free, easy to use, and provide automatic deployments when you push changes to your repository.
</Aside>

<Aside type="tip">
  Already have a CV or portfolio? You can easily migrate it to Devsync! In most cases, you won't need
  to rewrite everything manually. Just use the `Devsync Skill` and let AI handle the conversion for you.
</Aside>

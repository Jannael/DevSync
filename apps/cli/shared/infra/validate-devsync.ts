...
import { parseDevsync, type DevsyncPartial } from '@devsync/src/devsync-validator'
import { availableLangs } from '@devsync/src/const/fields-translations'
import { devsyncGlobalFields } from '@devsync/src/devsync'

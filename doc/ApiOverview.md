...
When i was creating the frontend i realized that it was kinda hard to find the
endpoint i needed to make what i wanted, so i created an api overview with

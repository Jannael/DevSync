...
const schema = z.object({
	...
	feature: z
		.array(
			z
				...
				.min(3, { message: 'feature must be at least 3 characters long' })
				.max(255, { message: 'feature must be at most 255 characters long' }),
		)
	...
	code: codeSchema,
	description: z
		.string('Description must be valid')
...
const validator = {
	...
	partial: (
		data: Partial<Pick<ISolution, 'code' | 'description' | 'feature'>>,
	) => {
		try {
